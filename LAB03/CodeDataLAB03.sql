...
CONSTRAINT CK_Phong_TrangThai CHECK(TrangThai IN (N'Tr?ng',N'Ðã d?t',N'Ðang
?',N'B?o trì')),
...
TrangThai nvarchar(30) NOT NULL DEFAULT N'Ðã d?t',
NgayNhanThucTe datetime NULL,
NgayTraThucTe datetime NULL,
CONSTRAINT CK_PhieuDat_Ngay CHECK(NgayTraDuKien >= NgayNhan),
CONSTRAINT CK_PhieuDat_Kenh CHECK(KenhDat IN (N'Ði?n
tho?i',N'Website',N'Tr?c ti?p')),
CONSTRAINT CK_PhieuDat_TrangThai CHECK(TrangThai IN (N'Ðã d?t',N'Ðang
?',N'Ðã tr?',N'No-show',N'H?y')),
...
TrangThai nvarchar(30) NOT NULL DEFAULT N'Chua thanh toán',
CONSTRAINT CK_HoaDon_TrangThai CHECK(TrangThai IN (N'Chua thanh toán',N'Ðã
thanh toán')),
...
SoTien decimal(18,2) NOT NULL CHECK(SoTien > 0),
CONSTRAINT CK_ThanhToan_HinhThuc CHECK(HinhThuc IN (N'Ti?n m?t',N'Chuy?n
kho?n',N'Th?',N'Ví di?n t?')),
...
VALUES
('A101','A',2,600000,N'Tr?ng'),('A102','A',3,800000,N'Tr?ng'),('B201','B',4,1200000,N'Tr?ng');
INSERT INTO LoaiTienNghi(MaLoaiTN,TenLoaiTN) VALUES ('TV',N'Ti vi'),('TL',N'T?
l?nh'),('DT',N'Ði?n tho?i');
INSERT INTO TienNghi(MaTienNghi,MaLoaiTN,SoThuTu,TinhTrangHienTai) VALUES
('TV01','TV',1,N'T?t'),('TV02','TV',2,N'T?t'),('TL01','TL',1,N'T?t');
INSERT INTO DichVu(MaDV,TenDV,DonViTinh,DonGia) VALUES
('DV01',N'An sáng',N'Su?t',120000),('DV02',N'T?m
hoi',N'Lu?t',250000),('DV03',N'Karaoke',N'Gi?',300000);
INSERT INTO QuyDinhDenBu(MaQuyDinh,MaLoaiTN,MucDoThietHai,MucDenBu)
VALUES
('QD01','TV',N'Hu h?ng nh?',500000),('QD02','TV',N'M?t',5000000),('QD03','TL',N'Hu h?ng
nh?',400000),('QD04','TL',N'M?t',4000000);
